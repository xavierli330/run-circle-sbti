...
export const generalQuestions: Question[] = [
  ...
  },
  {
    ...
    text: '你发现自己被跑友拉进了一个「每天5公里打卡，否则发红包」的群，你的第一反应是？',
    options: [
      { label: 'A', text: '立刻设置5个闹钟，把跑步当成KPI来完成' },
      { label: 'B', text: '默默潜水，等别人忘了我再退群，红包是不可能发的' },
      { label: 'C', text: '每天发Keep截图充数，其实截图是网上搜的' },
      { label: 'D', text: '反手把群主拉进「每天背100个单词」的群，互相伤害' },
    ]
  },
  {
  ...
  },
  {
    ...
    text: '如果跑步数据可以兑换成货币，以你目前的跑量，你的身价大概是？',
    options: [
      { label: 'A', text: '可以在二线城市付个首付，我的数据就是我的资产' },
      { label: 'B', text: '刚好够买一双碳板鞋，然后继续跑继续换' },
      { label: 'C', text: '只能买一碗兰州拉面加蛋，但汤可以免费续' },
      { label: 'D', text: '负债，因为我大部分时间都在躺平，数据是负的' },
    ]
  },
  {
  ...
  },
  {
    ...
    text: '如果跑步被纳入高考科目，你觉得自己现在的水平能上什么大学？',
    options: [
      { label: 'A', text: '清华北大随便挑，我的PB就是保送通知书' },
      { label: 'B', text: '211稳了，但985还需要再刷几个月跑量' },
      { label: 'C', text: '二本保底，主要是作文分高（指朋友圈文案写得好）' },
      { label: 'D', text: '蓝翔，因为我理论知识为零，只会躺着看直播' },
    ]
  },
  {
  ...
  },
  {
    ...
    text: '比赛途中你误把志愿者的云南白药喷雾当成了运动饮料喝了一口，接下来5公里你会？',
    options: [
      { label: 'A', text: '感觉喉咙在喷火，但配速莫名提升，可能激活了隐藏属性' },
      { label: 'B', text: '一边跑一边吐泡泡，成了赛道上一道独特的风景线' },
      { label: 'C', text: '拉着志愿者一起跑，要求她对我负责到底' },
      { label: 'D', text: '停下来拍个照发朋友圈：「今天的补给有点辣」' },
    ]
  },
  {
  ...
  },
  {
    ...
    text: '赛前你梦见自己到了起点，发现所有选手都穿着恐龙充气服，只有你是正常装备，你会？',
    options: [
      { label: 'A', text: '立刻在群里下单同款恐龙服，宁可热死也不能不合群' },
      { label: 'B', text: '保持冷静，利用 aerodynamic advantage（气动优势）拉爆他们' },
      { label: 'C', text: '假装自己是侏罗纪公园的管理员，边跑边喊「都别挤」' },
      { label: 'D', text: '觉得这个梦太离谱了，决定今天不跑了，回家继续睡' },
    ]
  },
  {
    id: 'A26', dimension: 'A4', isSoul: false,
    text: '比赛前一周，你的跑鞋突然开口说话，它对你说：',
    options: [
      { label: 'A', text: '「主人，我的碳板已经迫不及待想弹射你了。」' },
      { label: 'B', text: '「求你了，这次别穿我去踩水坑，我上次感冒还没好。」' },
      { label: 'C', text: '「其实我偷偷藏了上届选手的能量胶在鞋底，以备不时之需。」' },
      { label: 'D', text: '「别跑了，跟我一起宅在鞋柜里看《甄嬛传》吧。」' },
    ]
  },
  {
  ...
  },
  {
    ...
    text: '如果你跑步时必须带一件完全没用的东西，你会选？',
    options: [
      { label: 'A', text: '一只会叫的电子鸡，每跑一公里它就打鸣一次' },
      { label: 'B', text: '一面小镜子，用来确认自己的跑步表情够不够痛苦面具' },
      { label: 'C', text: '一本《五年高考三年模拟》，边跑边背文言文' },
      { label: 'D', text: '一个空的行李箱，假装自己是在机场赶飞机的商务人士' },
    ]
  },
  {
  ...
  // ============ A3 装备与仪式 ============
  {
    ...
    text: '如果你的运动手表成精了，它会怎么评价你？',
    options: [
      { label: 'A', text: '「他只有在VO2max涨了的时候才爱我。」' },
      { label: 'B', text: '「我每天最大的工作量是帮他记录去便利店买烟的步数。」' },
      { label: 'C', text: '「他跑步的时候心率都没看我的时候高。」' },
      { label: 'D', text: '「我们之间是纯洁的充电关系，平时没什么交流。」' },
    ]
  },
  {
    id: 'A32', dimension: 'A3', isSoul: false,
    text: '如果跑鞋可以像手机一样设置「勿扰模式」，你希望它能屏蔽什么？',
    options: [
      { label: 'A', text: '路边小吃摊的香味，每次跑到那里意志力就归零' },
      { label: 'B', text: '陌生跑友的搭讪：「兄弟，你这鞋多少钱买的？」' },
      { label: 'C', text: '洒水车的水雾，刚刷的鞋比我的心还凉' },
      { label: 'D', text: '自己的脚臭，眼不见心不烦，鼻子不闻鞋不臭' },
    ]
  },
  {
    id: 'A33', dimension: 'A3', isSoul: false,
    text: '你发现你的跑鞋在深夜偷偷打开了你的淘宝，购物车里多了三双限量款，你会？',
    options: [
      { label: 'A', text: '立刻下单，毕竟鞋比人更懂鞋，这叫专业对口' },
      { label: 'B', text: '严肃教育它：「你现在还有800公里寿命，别想投胎。」' },
      { label: 'C', text: '把购物车截图发朋友圈，配文「连我的鞋都想出轨」' },
      { label: 'D', text: '假装没看见，等快递到了就说是鞋自己买的，跟我没关系' },
    ]
  },
  {
  ...
  },
  {
    ...
    text: '如果你的奖牌架半夜活了，开始对着镜子练健美，它的动机最可能是？',
    options: [
      { label: 'A', text: '嫌自己的肌肉线条配不上你的完赛证书' },
      { label: 'B', text: '准备跳槽去邻居家，因为那里的奖牌更重' },
      { label: 'C', text: '想在你下次发朋友圈时，以一个更饱满的姿态入镜' },
      { label: 'D', text: '它觉得自己承受的重量已经超越了人类的认知极限' },
    ]
  },
  {
  ...
  // ============ A4 赛前与赛后 ============
  {
    ...
    text: '赛前一周，你的肠胃突然开始用微信跟你对话，它说：',
    options: [
      { label: 'A', text: '「兄弟，别再吃火锅了，我已经在准备赛道上的叛变了。」' },
      { label: 'B', text: '「给我来点干净的碳水，否则30公里后让你社会性死亡。」' },
      { label: 'C', text: '「其实我想吃炸鸡，你跑你的，我消化我的，互不干涉。」' },
      { label: 'D', text: '「无所谓，我已经习惯了，反正你每次都不听我的。」' },
    ]
  },
  {
    id: 'A47', dimension: 'A4', isSoul: false,
    text: '比赛当天早上，你发现自己的号码布被家里的猫抓成了流苏状，你会？',
    options: [
      { label: 'A', text: '立刻找胶带把它粘成行为艺术品，相信组委会会欣赏' },
      { label: 'B', text: '把猫也带上，说这是你的私补团队和情感支持动物' },
      { label: 'C', text: '在群里发照片求安慰，顺便收获一波「哈哈哈」' },
      { label: 'D', text: '佛系参赛，告诉志愿者「这是限量版战损皮肤」' },
    ]
  },
  {
  ...
  },
  {
    ...
    text: '比赛结束后，你的双腿开通了一个播客节目，第一期的主题是：',
    options: [
      { label: 'A', text: '《主人的意志力：是真实存在还是集体幻觉？》' },
      { label: 'B', text: '《论楼梯和马桶在赛后48小时内的恐怖统治》' },
      { label: 'C', text: '「其实我一点都不累，我只是假装酸痛来博取同情。」' },
      { label: 'D', text: '《什么时候去按摩？在线等，很急。》' },
    ]
  },
  {
    id: 'A50', dimension: 'A3', isSoul: false,
    text: '如果你必须选一件装备作为你的「跑步守护神」，你会选？',
    options: [
      { label: 'A', text: '永远有电的运动手表，它是你在赛道上唯一的信仰' },
      { label: 'B', text: '一条不会磨裆的压缩裤，它是你长距离路上的真菩萨' },
      { label: 'C', text: '一顶会自动遮阳的空顶帽，科幻但实用' },
      { label: 'D', text: '一个会说话的腰包，专门负责在撞墙期骂醒你' },
    ]
  },
  {
    id: 'A51', dimension: 'A4', isSoul: false,
    text: '如果完赛后的拉伸动作被拍下来发到网上，网友最可能给你的弹幕是：',
    options: [
      { label: 'A', text: '「这不是拉伸，这是在表演丧尸出笼。」' },
      { label: 'B', text: '「建议送去《我是歌手》，这呻吟比歌词还动人。」' },
      { label: 'C', text: '「泡沫轴：我承受了这个年纪不该承受的压力。」' },
      { label: 'D', text: '「别拉了，直接火化吧，看着都疼。」' },
    ]
  },
  {
  ...
  },
  {
    ...
    text: '跑步时，你总觉得路边某样东西在偷偷看你，最可能是？',
    options: [
      { label: 'A', text: '共享单车的座椅，它在嘲笑你「有腿为什么不骑」' },
      { label: 'B', text: '垃圾桶，它在评估你丢的能量胶包装是不是可回收' },
      { label: 'C', text: '红绿灯，它故意在你快到的时候变红，专门搞你心态' },
      { label: 'D', text: '路边的狗，它的眼神说明了一切：「这人跑得还没我快」' },
    ]
  },
  {
  ...
  },
  {
    ...
    text: '如果你跑步时鞋带必须每公里自动松开一次，你会怎么办？',
    options: [
      { label: 'A', text: '发明一种「永不松开鞋带」的系法，并申请专利' },
      { label: 'B', text: '把它当作间歇训练的休息信号，系鞋带就是组间休息' },
      { label: 'C', text: '干脆穿一脚蹬，向命运低头' },
      { label: 'D', text: '边跑边骂鞋带，把它当成前任来发泄' },
    ]
  },
  {
