export default {
  ...
  version: '4.0.0',
  totalQuestions: 32,
  questionPoolSize: 110,
  dimensions: [
    { id: 'A1', name: '动机与身份认同', poolSize: 15, perTest: 4 },
    { id: 'A2', name: '赛道行为模式', poolSize: 15, perTest: 4 },
    { id: 'A3', name: '装备与仪式', poolSize: 15, perTest: 4 },
    { id: 'A4', name: '赛前与赛后', poolSize: 15, perTest: 4 },
    { id: 'A5', name: '自我认知', poolSize: 15, perTest: 4 },
    { id: 'B1', name: '吃苦与享乐', poolSize: 12, perTest: 3 },
    { id: 'B2', name: '装备与强制', poolSize: 12, perTest: 3 },
    { id: 'B3', name: '爬升与技术', poolSize: 12, perTest: 3 },
    { id: 'B4', name: '风景与完赛', poolSize: 14, perTest: 3 },
  ],
  soulQuestions: [
